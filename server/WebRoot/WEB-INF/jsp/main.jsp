...
<link href="${ctx }/themes/green/style.css" rel="stylesheet" type="text/css" media="screen"/>
				...
				<div class="accordion" fillSpace="sidebar">
						 <c:if test="${SESSION_BEAN.role=='SysUser' }">
							...
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/querySysUser.action" target="navTab" rel="mainquery">管理员列表</a></li>
									 <li><a href="${ctx}/sys/queryDept.action" target="navTab" rel="mainquery">配送点列表</a></li>
									 <li><a href="${ctx}/sys/querySimpleUser.action?s_userType=公司员工" target="navTab" rel="mainquery">公司员工列表</a></li>
									 <li><a href="${ctx}/sys/querySimpleUser.action?s_userType=配送点管理员" target="navTab" rel="mainquery">配送点管理员列表</a></li>
									 <li><a href="${ctx}/sys/querySimpleUser.action?s_userType=配送点员工" target="navTab" rel="mainquery">配送点员工列表</a></li>
									 <li><a href="${ctx}/sys/querySimpleUser.action?s_userType=车辆管理员" target="navTab" rel="mainquery">车辆管理员列表</a></li>
									 <li><a href="${ctx}/sys/querySimpleUser.action?s_userType=司机" target="navTab" rel="mainquery">司机列表</a></li>
									 <li><a href="${ctx}/sys/querySimpleUser.action?s_userType=用户" target="navTab" rel="mainquery">用户列表</a></li>
								</ul>
							</div>
							<div class="accordionHeader">
								<h2><span>Folder</span>线路管理</h2>
							</div>
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryLine.action" target="navTab" rel="mainquery">线路列表</a></li>
								</ul>
							</div>
							<div class="accordionHeader">
								<h2><span>Folder</span>反馈管理</h2>
							</div>
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryFeedback.action" target="navTab" rel="mainquery">反馈信息</a></li>
								</ul>
							</div>
						</c:if>
						 <c:if test="${SESSION_BEAN.role=='SimpleUser' }">
						 	<c:if test="${SESSION_BEAN.user.userType=='车辆管理员' }">
								<div class="accordionHeader">
									<h2><span>Folder</span>车辆管理</h2>
								</div>
								<div class="accordionContent">
									<ul class="tree treeFolder">
										 <li><a href="${ctx}/sys/queryTruck.action" target="navTab" rel="mainquery">车辆信息列表</a></li>
									</ul>
								</div>
							</c:if>
						 	<c:if test="${SESSION_BEAN.user.userType=='用户' }">
								<div class="accordionHeader">
									<h2><span>Folder</span>订单管理</h2>
								</div>
								<div class="accordionContent">
									<ul class="tree treeFolder">
										 <li><a href="${ctx}/sys/queryMyOrder.action" target="navTab" rel="mainquery">我的寄件</a></li>
										 <li><a href="${ctx}/sys/queryMyRecvOrder.action" target="navTab" rel="mainquery">我的收件</a></li>
										 <li><a href="${ctx}/sys/queryFeedback.action" target="navTab" rel="mainquery">反馈信息</a></li>
									</ul>
								</div>
							</c:if>
						 	<c:if test="${SESSION_BEAN.user.userType=='配送点管理员' }">
								<div class="accordionHeader">
									<h2><span>Folder</span>订单管理</h2>
								</div>
								<div class="accordionContent">
									<ul class="tree treeFolder">
										 <li><a href="${ctx}/sys/queryDeptUserOrder.action" target="navTab" rel="mainquery">用户订单列表</a></li>
									</ul>
								</div>
								<div class="accordionHeader">
								...
								<div class="accordionContent">
									<ul class="tree treeFolder">
										 <li><a href="${ctx}/sys/queryDeptTransport.action" target="navTab" rel="mainquery">配送点物流信息列表</a></li>
										 <li><a href="${ctx}/sys/queryDeptJoinTransport.action" target="navTab" rel="mainquery">物流交接列表</a></li>
									</ul>
								</div>
								<div class="accordionHeader">
									<h2><span>Folder</span>配送点查询</h2>
								</div>
								<div class="accordionContent">
									<ul class="tree treeFolder">
										 <li><a href="${ctx}/sys/queryDept.action" target="navTab" rel="mainquery">配送点列表</a></li>
						...
						<div class="accordionContent">
							<ul class="tree treeFolder">
								 <li><a href="${ctx}/com/toSelf.action" target="navTab" rel="mainquery">修改个人资料</a></li>
							</ul>
						</div>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="pageFormContent" layoutH="80" style="margin-right:230px">
							...
							<c:if test="${SESSION_BEAN.role=='SimpleUser' }">(${SESSION_BEAN.user.userType})&nbsp;&nbsp;&nbsp;[${SESSION_BEAN.user.dept.name}] ${SESSION_BEAN.user.dept.address}
							</c:if>
							</p>
							<p style="color:red"> </p>
